...
func TestPointInside(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			// Test 9
			Polygon: Polygon{
				{51.50281238523426, 0.03922462463378906},
				{51.50388092395907, 0.04149913787841797},
				{51.503720644747645, 0.042400360107421875},
				{51.50364050493053, 0.043044090270996094},
				{51.50406791565989, 0.044417381286621094},
				{51.50396106335338, 0.046563148498535156},
				{51.50331994425266, 0.048880577087402344},
				{51.5027589576403, 0.04999637603759765},
				{51.50257196056819, 0.050811767578125},
				{51.502384962728755, 0.05424499511718749},
				{51.50201096474784, 0.059866905212402344},
				{51.5019575362143, 0.062055587768554694},
				{51.501690392607, 0.06862163543701172},
				{51.50134310357631, 0.07085323333740234},
				{51.50243839076119, 0.07038116455078125},
				{51.50567067019112, 0.07153987884521484},
				{51.506739141893, 0.040040016174316406},
				{51.50281238523426, 0.03922462463378906},
			},
			Point: Point{
				51.503185,
	...
	for i, test := range testCases {
		...
		if res != test.Expect {
			...
			// Report error
			t.Errorf("Expected point test to be %t, was %t on test %d", test.Expect, res, i+1)
		}
	}
}
